  ...
  return (
    <div className="flex flex-col gap-8 p-8 bg-dark">
      <div className="flex flex-col gap-2">
        <h1 className="text-2xl transition md:text-3xl text-white/70 hover:text-white">
      ...
      <div>
        <p className="text-lg md:text-xl">
          <span>{excerpt}</span> <span>...</span>{" "}
          <span className="text-blue-500 transition hover:text-white">
